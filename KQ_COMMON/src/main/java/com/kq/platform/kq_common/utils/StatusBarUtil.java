...
/**
 * Created by Zhou jiaqi on 2019/1/22.
 */
public class StatusBarUtil {
    ...
    @TargetApi(21)
    public static void setStatusBarColor(Activity activity, int colorRes, boolean dark){
        Window window = activity.getWindow();
        ...
        StatusBarUtil.setLightStatusBar(activity,dark);
    }
